...
\todo{il pin di interrupt???? Lasciamo stare}
...
\pagebreak
\noindent Nella tabella \ref{tab:ComponentiAdapterMaxm} vengono riassunti i componenti presente nell'\textit{Adapter Board} descritta.
\begin{table}[h]
...
\begin{figure}[b]
	...
	c$)$
	\includegraphics[width=0.1569\linewidth]{ImageFiles/Hardware/manifacturing_top_max}
	d$)$
	\includegraphics[width=0.1569\linewidth]{ImageFiles/Hardware/manifacturing_bottom_max}
	\caption{Layout Adapter Board: a$)$ Livello Top, b$)$ Livello Bottom, c$)$ Rendering 2D Top, d$)$ Rendering 2D Bottom}
