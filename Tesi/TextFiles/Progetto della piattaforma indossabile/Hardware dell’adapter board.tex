...
Il seguente studio rappresenta una continuazione del lavoro fatto in una tesi precedente svolta presso il laboratorio di elettronica dell’Università degli Studi di Bergamo \cite{Ingegneria2018}. In questa tesi viene introdotto un elemento aggiuntivo che è l'utilizzo della luce blu per acquisizioni fotopletismografiche che, combinata con le luci verde, rosso e infrarosso, già studiate, può migliorare la qualità delle stime ottenute. Un altro potenziale dell'impiego di questa luce è la possibilità di effettuare acquisizioni in nuove zone del corpo, ottenendo un sistema più flessibile e meno invasivo.
...
\begin{table}[h]
	...
	\begin{tabular}{cccc}
		...
		\textbf{I\ped{dd} Consumo corrente {[}$\mu$A{]}} &   16   &    20     &   14.5\\ \hline
	...
	\end{tabular}
	\caption{Confronto delle caratteristiche dei diversi accelerometri.}
	\label{tab:ConfrontoAccelerometri}
\end{table}
Il dispositivo scelto è il LIS2DW12. Si tratta di un accelerometro triassiale lineare ad alte performance e basso consumo, prodotto da STMicroelectronics e realizzato con tecnologia MEMS. LIS2DW12 rappresenta un'evoluzione del modello LIS2DH12, impiegato anche nella precedente tesi, che ne migliora le performance sia in termini di consumi che del rumore di misura aumentando la risoluzione passando da 12 a 14 bit.
\begin{figure}[b]
	\centering
...
\paragraph{Accelerometro} L'accelerometro utilizzato è il LIS2DW12 prodotto da STMicroelectronics, come nell'Adapter Board precedente.
\pagebreak
