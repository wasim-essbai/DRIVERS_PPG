...
Le piste disegnate hanno una larghezza di 0.2 mm e dei vias con diametro di 0.2, con una corona di \SI{254}{\micro\meter}.
\pagebreak
Nella tabella \ref{tab:ComponentiAdapterMax} vengono riassunti i componenti presenti nell'\textit{Adapter Board} descritta.
\begin{table}[h]
	\renewcommand{\arraystretch}{1.5}
	\centering
	\begin{tabular}{ccccc}
		...
		\hline ADP166  & Regolatore di tensione lineare (LDO) & \begin{tabular}{@{}c@{}}								
			...
			\hline Rumore in uscita: \SI{100}{\micro\volt}rms \\ 
		\end{tabular} \\
	\end{tabular}
