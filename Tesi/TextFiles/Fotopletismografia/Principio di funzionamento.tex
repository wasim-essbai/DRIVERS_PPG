...
Come mostrato nella figura \Fig~\ref{fig:PressioneSangue}, all'interno dell'aorta la pressione è mediamente alta pari a circa 100 mm Hg, con dei picchi di 120 mm Hg (\textit{pressione sistolica}) e dei minimi di 80 mm Hg (\textit{pressione diastolica}) \todo{spiegare a cosa sono dovuti questi picchi}.
 \begin{figure}[h]
 	\centering
 ...
 \end{figure}
\todo{definizione di pressione}
\todo{pressione su guyton e fisiologia umana}
