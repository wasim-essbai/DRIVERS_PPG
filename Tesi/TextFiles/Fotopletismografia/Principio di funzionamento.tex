...
\todo{immagini da sistemare e cambiare}
\begin{figure}[h]
	\centering
	\includegraphics[width=0.3\linewidth]{ImageFiles/Fotopletismografia/PPGTrasmissivo}
	\includegraphics[width=0.3\linewidth]{ImageFiles/Fotopletismografia/PPGRiflessiva}
	\caption{...}
	\label{fig:aa}
\end{figure}


\todo{da finire e rileggere: solamente scritto}
\todo{accelerometri}
